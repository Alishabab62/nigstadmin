...
function filter(){
  const url = `http://ec2-13-233-110-121.ap-south-1.compute.amazonaws.com/secure/filter?status=${verificationFilterValue}&email=${inputs.email}&organization=${inputs.orgName}&startDate=${startDateRef.current.value}&endDate=${endDateRef.current.value}`;
